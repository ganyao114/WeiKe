 ...
 */
@ContentView(R.layout.fragment_maintandata_month)
public class MonthDataFragment extends BaseFragmentV4 implements IShowList{

    @ViewInject(R.id.maintandata_monthtlist)
