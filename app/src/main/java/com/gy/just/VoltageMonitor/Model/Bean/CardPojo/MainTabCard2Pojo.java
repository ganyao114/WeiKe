...
public class MainTabCard2Pojo implements Serializable{
    ...
    public void setExceptions(int exceptions) {
        ...
        exception_text = "三天超限:" + exceptions + "台";
    }
