...
@ContentView(R.layout.activity_collect_and_history)
@InjectPresenter(CollectAndHistoryActivity.class)
public class CollectAndHistoryActivity extends BaseAppCompactActivity {
